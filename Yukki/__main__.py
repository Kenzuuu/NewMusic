...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!!  Narumi Robot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("narumisupport")
            await ASS_CLI_1.join_chat("narumisupport")
        except:
            pass
...
@app.on_message(filters.command("startmusic") & filters.private)
